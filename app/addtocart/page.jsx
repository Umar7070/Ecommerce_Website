      ...
      {cardItem.map((curEle, index) => {
        return (
          <motion.div
            ...
            key={index}
          >
            <div className="container relative flex flex-col md:flex-row gap-5 md:gap-[40px] shadow-lg p-5 md:p-10 my-5">
              <div>
                <img
                  src={curEle.img}
                  alt="card image"
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col md:flex-row gap-5 md:gap-[100px]">
                  <p className="text-md md:text-lg text-gray-600 my-2 md:my-5">
                    {curEle.title}
                  </p>
                  <div className="absolute top-2 right-2">
                    <RxCross1
                      onClick={() => deleteItem(curEle)}
                      className="text-xl md:text-2xl hover:text-blue-700 cursor-pointer"
                    />
                  </div>
                </div>
                <div className="my-3 text-2xl md:text-4xl font-bold cursor-pointer flex gap-3">
                  <p
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-bold text-red-600 text-xl md:text-2xl">
