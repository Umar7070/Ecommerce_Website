        ...
        <div className="container flex gap-[40px] shadow-lg p-10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-[100px]">
              ...
              <RxCross1 className="text-2xl hover:text-blue-700 cursor-pointer  " onClick={handleCard} />
            </div>
            <p>
            ...
            <div className="my-3 text-4xl  font-bold cursor-pointer flex gap-3">
              <p className="text-blue-800">+</p> <span>1</span> <span  className="text-blue-800 " >-</span>
            </div>
