        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 place-items-center  gap-6 p-5  mt-10">
          {ProductData.map((curEle, index) => {
            return (
              ...
              <div className="relative w-full bg-white shadow-2xl rounded-lg p-3 hover:shadow-3xl hover:scale-105 transition duration-300 ease-in-out group">
                <img
                  src={curEle.img}
                  alt=""
                ...
                <div className="bg-blue-400 p-1 rounded-lg  w-[50%] mx-auto items-center flex hover:bg-blue-500 justify-center text-white">
                  <button
