          ...
          >
            <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4  rounded w-[100%] mx-auto">
              ...
              <div className="flex justify-between gap-10">
                ...
                <div className="w-[60%]">
                  <div className="my-10">
                    <p className=" text-blue-700 capitalize font-bold text-2xl">
                      {product?.name}
                    </p>
                    ...
                    <p className="mt-5 hover:text-blue-700 font-bold text-gray-900 text-2xl">
                      {product?.price}
                    </p>
                    <div>
                      <button
                        onClick={handleClick}
                        className="bg-black text-white h-[40px] w-[150px] text-sm mt-10 rounded-md  capitalize"
                      >
                        add to cart
                      </button>
                    </div>
